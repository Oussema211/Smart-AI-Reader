...
random_img = r'C:\Users\ousseeeeemaaaaa\Desktop\water-meters-master\test_image.jpg'

segmentation_model_file = r'C:\Users\ousseeeeemaaaaa\Desktop\final20\final_segmentation-model'
faster_rcnn_path = r'C:\Users\ousseeeeemaaaaa\Desktop\model_final.pth' #<-- for cfg.MODEL.WEIGHTS
...
def get_reading(image_path):
    ...
    cfg.MODEL.WEIGHTS = r'C:\Users\ousseeeeemaaaaa\Desktop\model_final.pth'
...
print(f'Meter reading: {get_reading(random_img)}')
